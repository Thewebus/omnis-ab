...
@section('title')Liste classes - Fiche Enrolement Ministère
 {{ $title }}
@endsection
...
@section('content')
	@component("components.informatique.breadcrumb")
		@slot('breadcrumb_title')
			<h3>Liste classes - Fiche Enrolement Ministère</h3>
		@endslot
	        ...
	        <div class="col-sm-12">
	            <div class="card">
	                <div class="card-header">
	                    <h5>Liste des classes - Fiche Enrolement Ministère</h5>
	                        ...
	                        <table class="display" id="basic-2">
	                            ...
	                            <tbody>
	                                ...
	                                <tr>
	                                    ...
	                                    <td>{{ $classe->code }}</td>
	                                    <td style="width: 13vw">
											<a href="{{ route('admin.fiche-enrolement-minister-pdf', $classe) }}" class="btn btn-primary mt-3"><i class="fa fa-print"></i></a>
										</td>
	                                </tr>
									@endforeach
	                            </tbody>
