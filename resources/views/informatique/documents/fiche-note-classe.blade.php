...
@section('title')Liste classes - Fiche Note
 {{ $title }}
@endsection
...
@section('content')
	@component("components.informatique.breadcrumb")
		@slot('breadcrumb_title')
			<h3>Liste classes - Fiche Note</h3>
		@endslot
	        ...
	        <div class="col-sm-12">
	            <div class="card">
	                <div class="card-header">
	                    <h5>Liste des classes - Fiche Note</h5>
	                        ...
	                        <table class="display" id="basic-2">
	                            ...
	                            <tbody>
	                                ...
	                                <tr>
	                                    ...
	                                    <td>{{ $classe->code }}</td>
	                                    <td style="width: 13vw">
											<a href="{{ route('admin.fiche-note-liste-matiere', $classe) }}" class="btn btn-primary mt-3"><i class="fa fa-eye"></i></a>
										</td>
	                                </tr>
									@endforeach
	                            </tbody>
